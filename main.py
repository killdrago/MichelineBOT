...
class App:
    ...
    def _detect_agent_mode(self, text: str) -> bool:
        ...
        strong_triggers = [
            ...
            "execute", "executer", "execute ce code",
            "ping ", "ping google", "fais un ping",
            "connecte-toi", "connecte toi", "connect to",
            "connecte a mt5", "connecte-toi a mt5",
            "decompose", "decomposer", "decompose le probleme",
            "supprime", "supprimer", "delete", "efface",
            "code python", "print(", "sum(", "range(",
            "task_planner", "planifie",
            "shell", "terminal", "commande systeme",
            "web_search", "recherche web",
            "mt5", "metatrader", "ouvre", "ouvre moi", "ouvre-moi",
            "ouvrir", "ouvrir le",
            "lance moi", "lance-moi",
            "demarre", "demarrer",
            "start ", "open ",
            "bloc note", "bloc-notes", "notepad",
            "paint", "mspaint",
            "calculatrice", "calc",
        ]
